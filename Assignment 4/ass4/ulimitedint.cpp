...
UnlimitedInt::UnlimitedInt(string s)
{
    if (s[0] == '-')
    {
        ...
        {
            unlimited_int[s.length()-1-i]=static_cast<int>(s[i+1])- static_cast<int>('0');
        }
...
UnlimitedInt::UnlimitedInt(int i)
{
    ...
    else
    {
        ...
        for(int i =0;i<s.length();i++)
        {
            unlimited_int[s.length()-i-1]=s[i]- '0';
        }
    }
}
UnlimitedInt::~UnlimitedInt()
...
string UnlimitedInt::to_string()
{
 ...
 {
    dixpix+='0' + unlimited_int[size-1-i];
 }
 if (sign == -1)
 {
    dixpix = "-"+ dixpix;
  ...
  int i=0;
 while ( i<size && unlimited_int[i] == '0') {
       i++;
}
if (i == size)
{
...
else
{
    ...
    else if(i1->get_sign() == -1 && i2->get_sign() == -1)
    {
        ...
        UnlimitedInt* i3 = mul(i1,new UnlimitedInt(-1));
        UnlimitedInt* i4 = mul(i2,new UnlimitedInt(-1));
       return  mul(add(i3,i4), new UnlimitedInt(-1));
    }
...
// int main()
// {
//     UnlimitedInt* a = new UnlimitedInt(-10000);
