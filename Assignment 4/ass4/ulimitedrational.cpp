...
UnlimitedRational* lowerest(UnlimitedInt* i1, UnlimitedInt* i2){
    UnlimitedInt* big = new UnlimitedInt(i1->get_array(),i1->get_size(),1,i1->get_size());
    UnlimitedInt* small = new UnlimitedInt(i2->get_array(),i2->get_size(),1,i2->get_size());
    UnlimitedInt* temp;
...
UnlimitedRational::UnlimitedRational(UnlimitedInt* num, UnlimitedInt* den){
    UnlimitedInt* big = new UnlimitedInt(num->get_array(),num->get_size(),1,num->get_size());
    UnlimitedInt* small = new UnlimitedInt(den->get_array(),den->get_size(),1,den->get_size());
    UnlimitedInt* temp;
